		...
		<nav class="navbar navbar-top navbar-expand-md navbar-dark"
			...
			<div class="container-fluid">
				...
				<ul class="navbar-nav align-items-center d-none d-md-flex">
						...
						aria-expanded="false">
							<div class="media align-items-center">
								<span class="avatar avatar-sm rounded-circle"> <img
									...
									src="https://thumbs.dreamstime.com/b/people-profile-graphic-design-vector-illustration-eps-73567509.jpg">
								</span>
					...
					<li class="nav-item dropdown"><a class="nav-link pr-0"
						href="cart.jsp" role="button" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false">
							<div class="media align-items-center">

								<div class="media-body ml-2 d-none d-lg-block">

									<span class="mb-0 text-sm  font-weight-bold">Cart<span
										class="badge bg-danger">${cart_list.size()}</span></span>
								</div>
							</div>
					</a></li>
					...
					<li class="nav-item dropdown"><a class="nav-link pr-0"
						href="index.jsp" role="button" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false">
							<div class="media align-items-center">
					...
					<li class="nav-item dropdown"><a class="nav-link pr-0"
						href="orders.jsp" role="button" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false">
							<div class="media align-items-center">
					...
					<li class="nav-item dropdown"><a class="nav-link pr-0"
						href="log-out" role="button" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false">
							<div class="media align-items-center">
				...
				<div class="row">
					<div class="col-lg-7 col-md-10">
						...
						<p class="text-white mt-0 mb-5">This is your profile page. You
							can see your account details, make changes to it and also manage
							your profile</p>
							...
							<div class="row">
								<div class="col">
									...
									<div class="text-center">
										...
										<div class="h5 mt-4" style="overflow: auto; width: 100%">
											<%=email%>
										</div>
									...
									<div class="col-md-12">
										<div class="form-group focused">
											...
											<input id="input-address"
												...
												placeholder="580 Wiff Oaf Lane" value="" type="text">
										</div>
									</div>
								</div>
						...
						<form action="payment" method="post">
							...
							<div class="pl-lg-4">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group focused">
											...
											<label for="card" class="form-control-label">Choose a
												card:</label> <select name="card" id="input-address">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group focused">
											<label class="form-control-label" for="ccnum">Name on
												card</label> <input id="input-address"
												class="form-control form-control-alternative" type="text"
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<div class="form-group">
											<label class="form-control-label" for="input-country">Credit
												Balance</label> <input type="text" id="input-postal-code"
												class="form-control form-control-alternative"
